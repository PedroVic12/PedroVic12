...
- ⚡ Estágio de Estudos de Sistemas Elétricos de Potencia de 135KV,345KV e 440KV usando anaREDE e Organon para o ONS PLC 2025.2026
...
> **Legenda de Status:**  
> 🟢 **Online / Ativo** | 🔵 **Em Desenvolvimento** | 🟡 **Manutenção / Debug** | 🔴 **Sem Deploy**

### 🌐 Aplicações Web, IA & Dados

<table>
  <tr>
    <td width="50%">
      <h4>🟢 <a href="https://dashboard-moderno-ia.onrender.com/">Análise de Dados e Dashboards</a></h4>
      <p>Projeto 100% Python com Gemini AI auxiliando em tomadas de decisão baseadas em dados.</p>
      <img src="https://img.shields.io/badge/Python-Streamlit-blue?style=flat-square" />
    </td>
    <td width="50%">
      <h4>🟢 <a href="https://kyogre-ruby-delivery-pdv-react.vercel.app">Garçom PDV e Delivery</a></h4>
      <p>Sistema completo para restaurantes e bares com cardápio digital e sistema PDV.</p>
      <img src="https://img.shields.io/badge/React-FastAPI-blue?style=flat-square" />
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h4>🟢 <a href="https://api.whatsapp.com/send/?phone=5521988377364">Chatbot Groundon</a></h4>
      <p>Integração de IA para atendimento, utilizando programação assíncrona e estruturas de dados complexas.</p>
      <img src="https://img.shields.io/badge/NodeJS-Gemini_AI-green?style=flat-square" />
    </td>
    <td width="50%">
      <h4>🟢 <a href="https://astro-blog-pedrov12.vercel.app/">Blog Pessoal</a></h4>
      <p>Compartilhando minhas experiências em Engenharia Elétrica, Ciência de Dados e Programação.</p>
      <img src="https://img.shields.io/badge/Astro-Python-orange?style=flat-square" />
    </td>
  </tr>
</table>

### ⚡ Engenharia Elétrica & Otimização

<table>
  <tr>
    <td width="50%">
      <h4>🟡 <a href="https://github.com/PedroVic12/Repopulation-With-Elite-Set">Framework RCE</a></h4>
      <p>Framework de Algoritmo Evolutivo criado para publicação de artigo científico (2024-2025).</p>
      <img src="https://img.shields.io/badge/Python-DEAP-yellow?style=flat-square" />
    </td>
    <td width="50%">
      <h4>🟡 Análise de Contingências</h4>
      <p>Simulação N-1 e avaliação de violações em sistemas elétricos com output automatizado em DataFrame.</p>
      <img src="https://img.shields.io/badge/Pandas-Pandapower-yellow?style=flat-square" />
      <br><br>👉 <a href="https://github.com/PedroVic12">Ver Repositório</a>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h4>🔵 SEP Scripts</h4>
      <p>Automação elétrica, scripts de análise e fluxo de potência focados no Setor Elétrico.</p>
      <img src="https://img.shields.io/badge/Automation-Python-yellow?style=flat-square" />
      <br><br>👉 <a href="https://github.com/PedroVic12">Ver Repositório</a>
    </td>
    <td width="50%">
      <h4>🟢 Tracker de Projetos</h4>
      <p>Monitoramento de commits, análise de métricas de produtividade e foco em evolução de carreira.</p>
      <img src="https://img.shields.io/badge/Data_Tracking-orange?style=flat-square" />
      <br><br>👉 <a href="https://github.com/PedroVic12">Ver Repositório</a>
    </td>
  </tr>
</table>

### 🖥️ Interfaces Desktop & Dashboards

<table>
  <tr>
    <td width="50%">
      <h4>🔴 SysPL Desktop</h4>
      <p>Interface gráfica PySide6 (MVVM) criada para simular análises elétricas estilo ONS.</p>
      <img src="https://img.shields.io/badge/Desktop_App-PySide6-lightgrey?style=flat-square" />
      <br><br>👉 <a href="https://github.com/PedroVic12">Ver Repositório</a>
    </td>
    <td width="50%">
      <h4>🔵 Dashboard Streamlit</h4>
      <p>Visualização de dados, gráficos interativos e painel de exibição de resultados do algoritmo.</p>
